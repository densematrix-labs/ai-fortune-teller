...
class Settings(BaseSettings):
    # Database
    DATABASE_URL: str = "postgresql+asyncpg://postgres:postgres@postgres:5432/fortune"
    ...
    # Product pricing
    PRODUCTS: dict = {
        "fortune_pack_3": {"price": 799, "generations": 3},
        "fortune_pack_10": {"price": 1999, "generations": 10},
    }
